jQuery(document).ready(function($){	
	...
	$(function() {
		...
		$(".items img").mouseover(function(){
			...
			$(this).animate({opacity:1,width: 120, height: 80, top: "-30px", "z-index": 100, overflow: "visible"},200);
		})
		...
		$(".items img").mouseout(function(){
			$(this).stop();
			if (!$(this).hasClass('active'))
				$(this).animate({opacity:0.3, width: 60, height: 40,'z-index': 1},200);
			else
				$(this).animate({opacity:1, width: 60, height: 40,'z-index': 1},200);
		})  
	});
