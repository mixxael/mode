...
?>
	...
	<? } else { ?>
				<p align="justify" style="margin: 3 0 3 0;"> <font size="2px" color="#676166"> <strong>Вы неправильно заполнили поля!</strong> <a href="javascript:history.back();"><<<Назад</a></font>
	<? } ?>
	...
	<TABLE cellPadding=0 style="border-collapse: collapse" bordercolor="#111111" class=graybg width="558">
		...
		<TBODY>
			...
			<tr>
				...
				<TEXTAREA style="width: 330px; HEIGHT: 80;font-size:8pt" name=Remarks rows="1" cols="20"></TEXTAREA></td></tr>
			<tr>
